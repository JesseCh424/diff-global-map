...
def parse_args():
    ...
    parser.add_argument('--data-root', type=str, help='root path containing train/val/test')
    parser.add_argument('--dest-path', type=str, default=None, help='output path for pkl files (default: data-root)')
    parser.add_argument('--newsplit', action='store_true', help='use predefined split files')
...
if __name__ == '__main__':
    ...
    create_av2_infos_mp(
        ...
        log_ids=train_split,
        info_prefix='av2',
        dest_path=(args.dest_path or args.data_root),
